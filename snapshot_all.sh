...
# Configuración
SNAPSHOT_NAME="auto-snapshot"  # Nombre base del snapshot lo puedes cambiar a tu gusto
...
VM_IDS=$(qm list | awk '{if(NR>1 && $1 < 900) print $1}')  # Excluye IDs >= 900 y la cabecera, mantener las plantillas por sobre estos id 900 y las vm por bajo de esta id
